...
class FormularioImgJuego extends Form {
    ...
    protected function procesaFormulario($datos) {
        ...
        $nombreImagen=$juego->getName().".png";
        ...
        if ( $ok ) {
            ...
            */
            ...
            if ( $ok ) {
                ...
                if (!is_writable(DIR_JUEGOS_PROTEGIDOS)) {
                    echo DIR_JUEGOS_PROTEGIDOS;
                ...
                if ( !move_uploaded_file($tmp_name, DIR_ALMACEN. "/{$nombre}") ) {
                    ...
                    if ( !copy(DIR_ALMACEN. "/{$nombre}", DIR_JUEGOS_PROTEGIDOS. "/{$nombreImagen}") ) {
